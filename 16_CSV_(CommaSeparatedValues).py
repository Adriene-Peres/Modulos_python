...
CAMINHO_CSV = Path(__file__).parent / '16_exemplo.csv'

# with open(CAMINHO_CSV, 'r', encoding='utf8') as arquivo:
#     leitor = csv.reader(arquivo) # le em formato de lista

#     for linha in leitor:
#         print(linha)

with open(CAMINHO_CSV, 'r', encoding='utf8') as arquivo:
    leitor = csv.DictReader(arquivo)  # le em formato de dicionario
